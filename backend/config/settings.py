...
# WhiteNoise is used in production to serve collected static files (including Django admin assets).
# During development, prefer the default staticfiles storage to avoid requiring `collectstatic`.
STORAGES = {
    "default": {
